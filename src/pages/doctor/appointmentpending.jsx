  ...
  return (
    <div className="bg-gradient-to-br from-purple-200 to-blue-200 min-h-screen p-6 font-serif">
      ...
      <div className="bg-white rounded-lg shadow-lg p-6 mb-8 transition-transform transform hover:scale-105 duration-300 d-flex">
        ...
        <button onClick={() => filter(date.date)} className="bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold py-3 px-6 rounded-lg shadow-lg hover:from-blue-600 hover:to-purple-700 transition duration-300 transform hover:scale-105">
          Filter Appointment
        </button>
      </div>
